...
export default function Mission() {
  ...
  return (
    <>
    <div className="bg-[#F5F5F5] px-39 py-30">
                <h2 className="pb-20 text-[34px] font-bold text-center">Our Mission</h2>
      <div className="flex   gap-6  ">
        {arry.map((el, index) => {
          return (
            <div key={index} className=" bg-white p-6 border-[#22222233] border rounded-xl">
              ...
              {
                el.more ==="View More"?
<svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} viewBox="0 0 24 24"><path fill="currentColor" d="M13.47 8.53a.75.75 0 0 1 1.06-1.06l4 4a.75.75 0 0 1 0 1.06l-4 4a.75.75 0 1 1-1.06-1.06l2.72-2.72H6.5a.75.75 0 0 1 0-1.5h9.69z"></path></svg>                :""
              }
